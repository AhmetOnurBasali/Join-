    ...
    <form class="edit-task-container" onsubmit="createNewTask(event);">
        ...
        <div onclick="proofInput('msgBoxPrio')" class="prio">
            ...
            <div style="display: flex; justify-content: space-between;">
                <div id="highBtnContainer" class="checkbox-container">
                    <input onclick="setPrioCheckBox('urgent')" id="urgentBtnEdit" class="checkboxPosi" type="checkbox"> 
                ...
                <div id="normalBtnContainer" class="checkbox-container">
                    <input onclick="setPrioCheckBox('medium')" id="mediumBtnEdit" class="checkboxPosi" type="checkbox">
                ...
                <div id="lowBtnContainer" class="checkbox-container">
                    <input onclick="setPrioCheckBox('low')" id="lowBtnEdit" class="checkboxPosi" type="checkbox">
