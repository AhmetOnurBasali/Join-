      ...
      <div class="leftAndRightContainer">    
        <div class="leftSection">
          ...
          <div onclick="proofInput('msgBoxAssignedTask')" class="inputContainer" id="inputContainer">
            ...
            <div onclick="openAssignedTo('arrayAssigned', 'contactDiv', 'contactList', 'contacts', 'contactInitials', 'inputContainer')" id="contactDiv" class="openCategoryContainer" title="Please choose a contact">Select contact to assign 
